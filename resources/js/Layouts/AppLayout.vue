            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('materiasPrimas.index')" :active="route().current('materiasPrimas.index')">
                                    Materias Primas
                                </NavLink>
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('materiasPrimas.index')" :active="route().current('materiasPrimas.index')">
                            Materias Primas
                        </ResponsiveNavLink>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink v-if="$page.props.jetstream.hasApiFeatures" :href="route('api-tokens')"
